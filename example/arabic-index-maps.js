...
// global arrays
// ---------------------------------------------------
// Arabization by daleel Blogger
// http://bgarabic.blogspot.com/
// Date : 02-07-2012
// Developed by daleel Blogger
// ---------------------------------------------------
...
// this function creates a three-column table and adds it to the screen
   ...
   for (var i = 0; i < postTitle.length; i++) {
      if (filter == '') {
         tocTable += '<tr><td class="toc-entry-col1"><a target="'+target+'" href="' + postUrl[i] + '" title="' + postSum[i] + '">' + postTitle[i] + '</a></td><td class="toc-entry-col2">' + postDate[i] + '</td><td class="toc-entry-col3">' + postLabels[i] + '</td></tr>';
         numDisplayed++;
      } else {
